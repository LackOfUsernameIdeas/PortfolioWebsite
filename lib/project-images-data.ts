...
export const PROJECT_CARD_IMAGES: Record<string, string> = {
  ...
  nutrifit: "/nutrifit/nutrifit.png",
...
export const PROJECT_IMAGES: Record<string, { src: string; caption: Localized }[]> = {
  ...
  mindreel: [
    ...
    {
      src: "/mindreel/mindreel10.png",
      caption: {
        en: "The New Recommendations page, after the VR cinema experience option is chosen, showing the entry button to the A-Frame virtual scene, alongside a keyboard and mouse controls reference panel (WASD and arrow keys for navigation, left mouse button drag for rotation)",
  ...
  nutrifit: [
    ...
    {
      src: "/nutrifit/nutrifit14.png",
      caption: {
        en: "Meal plan generation result - dishes with food images, quantity, and daily calorie and macro totals with their deviations in absolute grams and percentage. This image also shows the diet type tooltip modal explaining each type in detail",
  ...
  tikfluence: [
    ...
    {
      src: "/tikfluence/tikfluence2.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence3.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence4.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence5.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence6.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence7.png",
      caption: {
        en: "The statistics shown apply to the selected song from the respective ranking, including position in the ranking of most popular songs, changes in the popularity statistics over time, and daily growth on views, videos made, and popularity index",
    ...
    {
      src: "/tikfluence/tikfluence8.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence9.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence10.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence11.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluence12.png",
      caption: {
    ...
    {
      src: "/tikfluence/tikfluenceDB.png",
      caption: {
